<?php $__env->startSection('title', 'Rekap Laba'); ?>
<?php $__env->startSection('topbar-title', 'Rekap Laba'); ?>
        ...
        <div class="card-body">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <div class="text-2xl font-bold" style="color: var(--dark);">Rp <?php echo e(number_format($totalPendapatan, 0, ',', '.')); ?></div>
                </div>
        ...
        <div class="card-body">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <div class="text-2xl font-bold" style="color: var(--dark);">Rp <?php echo e(number_format($totalModal, 0, ',', '.')); ?></div>
                </div>
        ...
        <div class="card-body">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <div class="text-2xl font-bold" style="color: var(--dark);">Rp <?php echo e(number_format($totalLaba, 0, ',', '.')); ?></div>
                </div>
...
<div class="card mb-6">
    <div class="p-6">
        <form action="<?php echo e(route('admin.laba.index')); ?>" method="GET">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                ...
                <div class="md:col-span-4 flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.laba.index')); ?>" class="btn btn-light px-3" title="Reset Filter">
...
<script>
    ...
    var table = $('#labaTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('admin.laba.index')); ?>",
                data: function (d) {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ecommerce-alkhomart\resources\views/admin/laba/index.blade.php ENDPATH**/ ?>