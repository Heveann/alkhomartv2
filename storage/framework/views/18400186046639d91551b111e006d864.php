...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 text-center">
    ...
    <div class="mt-16">
        <a href="<?php echo e(route('pembeli.products')); ?>" class="inline-flex justify-center items-center px-10 py-4 bg-black text-white font-medium text-sm tracking-widest uppercase rounded-xl hover:bg-gray-800 transition-colors shadow-lg shadow-black/20">
            Shop The Collection
        </a>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ecommerce-alkhomart\resources\views/pembeli/collection.blade.php ENDPATH**/ ?>