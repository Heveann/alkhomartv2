    ...
    <div class="flex flex-col lg:flex-row gap-16">
                ...
                <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center gap-6 pb-6 border-b border-gray-100">
                        ...
                        <div class="flex-1 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div>
                                <strong class="block text-lg font-medium text-black mb-1"><?php echo e($cart->product->nama_produk); ?></strong>
                                <span class="text-sm text-gray-500">Qty: <?php echo e($cart->jumlah); ?> &times; Rp <?php echo e(number_format($cart->product->harga, 0, ',', '.')); ?></span>
                            </div>
        ...
        <div class="w-full lg:w-1/3">
            <div class="bg-[#F9F9F9] p-8 lg:p-10 sticky top-24">
                ...
                <form id="checkoutForm" action="<?php echo e(route('pembeli.checkout.process')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                ...
                <a href="<?php echo e(route('pembeli.cart')); ?>" class="w-full bg-transparent border border-black text-black hover:bg-black hover:text-white font-medium text-sm tracking-widest uppercase py-5 px-4 transition-colors flex justify-center items-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ecommerce-alkhomart\resources\views/pembeli/checkout/index.blade.php ENDPATH**/ ?>