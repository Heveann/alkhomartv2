        ...
        <div class="card-body">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <div class="text-2xl font-bold" style="color: var(--dark);"><?php echo e($totalProduk); ?></div>
                </div>
        ...
        <div class="card-body">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <div class="text-2xl font-bold" style="color: var(--dark);"><?php echo e($totalTransaksi); ?></div>
                </div>
        ...
        <div class="card-body">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <div class="text-2xl font-bold" style="color: var(--dark);">IDR <?php echo e(number_format($totalPendapatan, 0, ',', '.')); ?></div>
                </div>
        ...
        <div class="card-body">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <div class="text-2xl font-bold" style="color: var(--dark);">IDR <?php echo e(number_format($totalLaba, 0, ',', '.')); ?></div>
                </div>
...
<div class="card mb-6 overflow-hidden">
    ...
    <div class="card-footer bg-white border-t border-slate-100 p-4 text-right">
        <a href="<?php echo e(route('admin.laba.index')); ?>" class="font-bold text-sm uppercase tracking-wider" style="color: #6200ea; text-decoration:none;">Open Report <i class="bi bi-chevron-right ml-1"></i></a>
    </div>
</div>
    ...
    <div class="lg:col-span-2">
        <div class="card h-full">
            <div class="card-header flex justify-between items-center">
                ...
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-primary" style="padding: 0.25rem 0.5rem; font-size: 0.75rem;">View All</a>
            </div>
            <div class="card-body p-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr style="border-bottom: 1px solid var(--border-color);">
                                    <td class="p-3 text-sm font-medium" style="color: var(--dark);"><?php echo e($order->kode_transaksi); ?></td>
                                    <td class="p-3 text-sm"><?php echo e($order->user?->name ?? 'Guest User'); ?></td>
                                    <td class="p-3 text-sm font-medium text-right" style="color: var(--primary);">IDR <?php echo e(number_format($order->total_harga, 0, ',', '.')); ?></td>
        ...
        <div class="card h-full">
            ...
            <div class="card-body">
                <div class="grid gap-3 mb-4">
                    <a href="<?php echo e(route('admin.kasir.index')); ?>" class="btn btn-primary w-full">
                        <i class="bi bi-calculator-fill"></i> Launch POS Terminal
                    </a>
                    <a href="<?php echo e(route('admin.products.index')); ?>" class="btn btn-light w-full">
                    ...
                    datasets: [
                        {
                            ...
                            maxBarThickness: 40,
                            data: <?php echo json_encode($chartDataOffline); ?>,
                        },
                        {
                            label: "Online",
                            ...
                            borderColor: "transparent",
                            maxBarThickness: 40,
                            data: <?php echo json_encode($chartDataOnline); ?>,
                        }
                    ],
                },
                options: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ecommerce-alkhomart\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>