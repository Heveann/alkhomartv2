...
<head>
    ...
    <title>@yield('title', 'Admin') — AlkhoMart Dashboard</title>
            ...
            <li class="relative" x-data="{ userMenuOpen: false }" @click.away="userMenuOpen = false">
                <button @click="userMenuOpen = !userMenuOpen" class="flex items-center gap-2 focus:outline-none bg-transparent border-none cursor-pointer p-0">
                    <div class="hidden md:block text-right mr-2">
                        <div class="text-sm font-medium" style="color: var(--gray);">{{ auth()->user()->name ?? 'Administrator' }}</div>
                    </div>
                ...
                <div x-show="userMenuOpen" 
                    ...
                    <h6 class="px-4 py-2 text-xs font-bold text-slate-400 uppercase tracking-wider mb-0 border-b border-slate-100">
                        <div class="text-slate-800 font-bold mb-1">{{ auth()->user()->name }}</div>
                        {{ auth()->user()->email }}
                    </h6>
    ...
    <div class="sb-sidenav-container">
        ...
        <nav class="sb-sidenav">
            ...
            <div class="sb-sidenav-menu">
                ...
                <a class="nav-link" href="{{ route('admin.produk-preview') }}" target="_blank">
                ...
                <a class="nav-link {{ request()->routeIs('admin.laba.*') ? 'active' : '' }}" href="{{ route('admin.laba.index') }}">
            ...
            <footer class="mt-auto py-4 bg-white border-t border-slate-200">
                <div class="px-4">
                    <div class="flex flex-col md:flex-row justify-between items-center text-sm" style="color: var(--gray);">
                        <div>Copyright &copy; AlkhoMart {{ date('Y') }}</div>
                        <div>
