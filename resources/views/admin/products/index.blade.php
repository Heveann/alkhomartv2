...
@section('topbar-title', 'Manage Products')
...
<div class="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-7">
    ...
    <div class="metric-card">
        ...
        <div>
            ...
            <div class="metric-value" style="color: {{ $lowStockCount > 0 ? '#dc2626' : '#16a34a' }}">
...
<div class="table-card">
    ...
    {{-- DataTable: DataTables will inject its own wrappers --}}
...
<div id="modalAddProduct" style="display:none;position:fixed;inset:0;z-index:9999;">
    ...
    <div id="modalPanel"
        ...
        <div style="padding:24px 28px;overflow-y:auto;flex:1;">
            ...
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" id="formAddProduct">
                @csrf
                ...
                <div style="margin-bottom:18px;">
                    ...
                    <input type="text" name="nama_produk"
                           ...
                           required
                           style="width:100%;padding:11px 16px;background:#f8fafc;border:1px solid {{ $errors->has('nama_produk') ? '#fca5a5' : '#e2e8f0' }};border-radius:12px;font-size:14px;color:#334155;font-weight:500;outline:none;box-sizing:border-box;transition:border-color .15s,box-shadow .15s;"
                ...
                <div style="margin-bottom:18px;">
                    ...
                    <select name="category_id"
                            style="width:100%;padding:11px 16px;background:#f8fafc;border:1px solid {{ $errors->has('category_id') ? '#fca5a5' : '#e2e8f0' }};border-radius:12px;font-size:14px;color:#334155;font-weight:500;outline:none;box-sizing:border-box;cursor:pointer;"
                            onfocus="this.style.borderColor='#93c5fd';this.style.boxShadow='0 0 0 3px rgba(59,130,246,.12)';"
                            onblur="this.style.boxShadow='none';this.style.borderColor='#e2e8f0';">
                    ...
                    <div>
                        ...
                        <div style="display:flex;">
                            ...
                            <input type="text" id="add_harga_display" inputmode="numeric"
                                   ...
                                   onfocus="this.style.borderColor='#93c5fd';this.style.boxShadow='0 0 0 3px rgba(59,130,246,.12)';"
                                   onblur="this.style.boxShadow='none';this.style.borderColor='#e2e8f0';">
                            <input type="hidden" name="harga" id="add_harga_raw" value="{{ old('harga') }}">
                        </div>
                    </div>
                    <div>
                        ...
                        <div style="display:flex;">
                            ...
                            <input type="text" id="add_harga_modal_display" inputmode="numeric"
                                   value="{{ old('harga_modal') ? number_format(old('harga_modal'), 0, ',', '.') : '' }}"
                                   placeholder="0" required
                                   style="flex:1;padding:11px 14px;background:#f8fafc;border:1px solid #e2e8f0;border-radius:0 12px 12px 0;font-size:14px;color:#334155;font-weight:500;outline:none;min-width:0;"
                                   onfocus="this.style.borderColor='#93c5fd';this.style.boxShadow='0 0 0 3px rgba(59,130,246,.12)';"
                                   onblur="this.style.boxShadow='none';this.style.borderColor='#e2e8f0';">
                            <input type="hidden" name="harga_modal" id="add_harga_modal_raw" value="{{ old('harga_modal') }}">
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-bottom:18px;">
                    ...
                    <input type="number" name="stok" value="{{ old('stok', 0) }}" placeholder="0" min="0" required
...
// ── Modal Edit Produk ──────────────────────────────
var editDataBaseUrl = '{{ url('admin/products') }}';
